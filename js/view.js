...
function appointmentsView() {
    ...
    if(model.appointmentEditMode == false && model.specialEventEditMode == false) {
        html +=`<div id="changeBox" class="hendelser">
            ...
            <h1>${model.selectedDate} ${model.months[model.currentMonth - 1]} ${model.currentYear} | ${model.currentTime}</h1>
                ...
                <a href="#" onclick="specialEventEditMode(true)"> 
...
function addAppointment() {
    ...
    html +=` 
        ...
        <input type="submit" class="appointment__add-button" value="Legg til i kalender" onclick="pushToAppointmentsArray();appointmentEditMode(false)"> 
        </div>`
    return html;
}
...
function specialEventMenu() {
    ...
    html +=` 
        ...
        <input type="submit" class="appointment__add-button" value="Legg til i kalender" onclick="specialEventEditMode(false)"> 
    </div>`
    return html;
}
