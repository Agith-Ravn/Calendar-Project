...
//--------------------------- Appointments ---------------------------
    ...
    appointments: [//år , mnd (zero index) , dato
        ...
        { id: '2021-04-22-3', date: new Date(2021, 3, 22), time: '09:30',  header: 'Test3.3',                    content: 'Test',                                                         color: '#ffdd00', visibility: {modul1: true,   modul2: true,  modul3: true,  startIT: true,  privat: true,}},
        ...
        { id: '2021-04-27-1', date: new Date(2021, 3, 27), time: '09:15',  header: 'Forbrede på fremføring',     content: 'Lage en plan på hva vi skal si og vise, og hvem som sier hva', color: '#0037ff', visibility: {modul1: false,  modul2: false,  modul3: false,  startIT: false,  privat: true,}},
